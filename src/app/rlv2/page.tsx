...
export default async function RlV2Page() {
    ...
    return (
      <main className="min-h-screen px-5 py-10">
        <section className="mx-auto max-w-2xl rounded-md border border-[color:var(--line)] bg-[color:var(--panel)] p-6">
          ...
          <h1 className="mt-3 text-2xl font-semibold">RL V2 Dashboard Locked</h1>
  ...
  return <DashboardClient initial={initial} initialTab="rl" rlVariant="v2" />;
}
